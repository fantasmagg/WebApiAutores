...
namespace WebApi.Controllers.V2
{
    ...
    [CabeceraEstaPresente("x-vercion", "2")]
    ...
    public class AutoresController : ControllerBase
    {
        ...
        //sin mappear
        [HttpGet(Name = "obtenerAutoresv2")] // api/autores/primero
        [AllowAnonymous]// eso es para cuando tengamos una clase con el filtro de Authorize, y no queramos que este enpoy pase por 
        // la Authorize
        ...
        public async Task<ActionResult<List<AutorDTOs>>> Get()
        {
            ...
            autores.ForEach(a => a.Nombre = a.Nombre.ToUpper());
        ...
        [HttpGet("{id:int}", Name = "obtenerAutorv2")] // api/autores/primero
        [AllowAnonymous]
        [ServiceFilter(typeof(HATEOASAutorFilterAttribute))]
        ...
        [HttpGet("{nombre}", Name = "obtenerAutorPorNombrev2")] // api/autores/primero
        ...
        public async Task<ActionResult> post([FromBody] AutorCreacionDTOs autorCreacionDTOs)
        {
            ...
            return CreatedAtRoute("obtenerAutorv2", new { autor.Id }, autorDTO); // aqui solo estamos devolviendo un 200
        ...
        [HttpPut("{id:int}", Name = "ActualizrAutorv2")] //api/autores/1
        ...
        [HttpDelete("{id:int}", Name = "BorrandoUnAutorv2")]
